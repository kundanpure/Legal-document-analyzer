...
try:
    ...
    logger.warning(" Google Cloud Translation not available - using mock translation service")
    ...
    def __init__(self):
        ...
        if self.use_google_translate:
            try:
                ...
                logger.warning(f" Google Translation initialization failed: {e}, using mock client")
