...
class GeminiAnalyzer:
    ...
    def __init__(self):
        ...
        self.preferred_chat = ["gemini-3.5-flash", "gemini-2.0-pro"]
        self.preferred_analysis = ["gemini-2.0-pro", "gemini-2.0-flash"]
...
"""
    ...
    def _parse_analysis_result(self, analysis_text: str) -> Dict[str, Any]:
        ...
        if not m:
            logger.error(f"Failed to parse JSON, raw text: {analysis_text[:200]}")
            return {
                "document_type": "unknown",
                "summary": analysis_text[:500] if analysis_text else "No valid analysis returned.",
